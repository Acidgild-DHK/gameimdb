...
public class DBConnection {
	...
	private void loadProperties(Properties prop) throws DBExceptions {
		...
		URL jarUrl = this.getClass().getClassLoader().getResource(prop.getProperty("driver_path"));
		String jar = DBConstants.jar.replace("{{driverPath}}", jarUrl.toString());
		...
		if(dType.equals("mysql")) {
			String dat = prop.getProperty("database_address");
